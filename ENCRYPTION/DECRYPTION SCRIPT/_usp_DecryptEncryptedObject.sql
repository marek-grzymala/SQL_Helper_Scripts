...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[_usp_DecryptEncryptedObject] 
	@EncryptedObjectOwnerOrSchema SYSNAME, 
	@EncryptedObjectName SYSNAME,
    @ObjectID INT = NULL,              /* if value supplied, it has to match Schema and Object Name above */
    @ObjectType NVARCHAR(128) = NULL,  /* if value supplied, it has to match Schema and Object Name above */
    @CreateDecryptedVersion BIT = 0,
    @PrintOutObjectDefinition BIT = 1,
    @RenamedObjectSuffix NVARCHAR(10) = '_ENCRYPTED'
AS
BEGIN
...
DECLARE @ErrorMsg NVARCHAR(2047),
        @SessionId INT,
...
BEGIN
    DECLARE @EncryptedObjectNewName SYSNAME = @EncryptedObjectName + @RenamedObjectSuffix;
