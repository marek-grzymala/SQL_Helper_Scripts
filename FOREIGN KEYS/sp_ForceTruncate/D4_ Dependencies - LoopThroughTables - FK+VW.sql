...
(
  ...
  --, [ReferencedObjectSchema]  NVARCHAR(128) NOT NULL
  --, [ReferencedObjectName]    NVARCHAR(128) NOT NULL
...
BEGIN
	...
	SELECT		DISTINCT
			  ...
			  , [sqm].[definition]  AS [ViewDefinition]
			  , [Xtp].[@level0type]
			  , [Xtp].[@level0name]
			  , [Xtp].[@level1type]
			  , [Xtp].[@level1name]
...
/* --------------------------------------------------------- End of Insert into [#SchemaBoundViews]: -------------------------------------------------------------  */
