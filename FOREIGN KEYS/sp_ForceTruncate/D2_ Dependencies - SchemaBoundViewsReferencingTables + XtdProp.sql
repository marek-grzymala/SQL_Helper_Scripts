...
DECLARE @SqlCreateView      NVARCHAR(MAX)
      , @ReferencedTableName SYSNAME = 'HumanResources.Employee'					--'Production.Product'
...
--FROM [sys].fn_listextendedproperty(NULL, N'SCHEMA', N'HumanResources', N'VIEW', N'vEmployee', NULL, NULL)
--FROM [sys].fn_listextendedproperty(NULL, N'SCHEMA', N'HumanResources', N'VIEW', N'vEmployee', NULL, NULL)
FROM [sys].fn_listextendedproperty(NULL, N'SCHEMA', N'Sales', N'VIEW', N'vProductAndDescription2', NULL, NULL)
...
--FROM [sys].fn_listextendedproperty(NULL, @level0type, @level0name, @level1type, @level1name, NULL, NULL)
--FROM [sys].fn_listextendedproperty(NULL, N'SCHEMA', N'HumanResources', N'VIEW', N'vEmployee', NULL, NULL)
--FROM [sys].fn_listextendedproperty(NULL, N'SCHEMA', N'Production', N'VIEW', N'vProductAndDescription', NULL, NULL)
FROM [sys].fn_listextendedproperty(NULL, N'SCHEMA', N'Sales', N'VIEW', N'vSalesPerson', NULL, NULL)
...
END
SELECT @SqlCreateView AS [@SqlCreateView]
